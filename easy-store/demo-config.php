...
function mt_demo_importer_config(){
			...
			$giturl 		= 'https://raw.githubusercontent.com/mysterythemes/themes-demo-pack/master/easy-store/default-demo/';
			$demo_config 	= array(
				'easy-store' => array(
					...
					'version'           => '1.2',
					'theme_settings' 	=> $giturl . 'default-demo/easy-store-export.dat',
					'xml_file'     		=> $giturl . 'default-demo/easy-store.xml',
					'widgets_file'  	=> $giturl . 'default-demo/easy-store-widgets.wie',
					'preview_screenshot'=> $giturl . 'default-demo/screenshot.png',
